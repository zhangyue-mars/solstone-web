export default {
    ...
    "mj": {
        ...
        "attachmentPresentWarning": "Ekler mevcutken derin düşünme modu etkinleştirilemez",
        "upPdf": "<span>Resim veya ek yükle<br/>Resimler, PDF'ler, EXCEL ve diğer belgeleri yükleyebilirsiniz</span><p>Sürükle ve bırak destekleniyor</p>",
        "upImg": "<span><b>Resim Yükle</b><br/>Otomatik olarak gpt-4-vision-preview modelini çağırır<br>Not: Ek resim ücretleri uygulanabilir<br/>Formatlar: jpeg, jpg, png, gif</span><p>Sürükle ve bırak destekleniyor</p><p class=\"pt-2\"><b>MP3 MP4 Yükle</b> <br>Otomatik olarak doğrudan whisper-1 modelini çağırır<br>Formatlar: mp3, mp4, mpeg, mpga, m4a, wav, webm</p>",
