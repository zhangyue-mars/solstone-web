...
export default {
	...
	chat: {
		...
		annouce: "公告",
		annouceContent:
			"本网站所有内容均与煤矿知识相关，由用户自行承担。;本网站仅供煤矿学习与参考之用。;使用本网站产生的任何问题由用户自行承担。",
		helpTitle:
			"今天我能为您做些什么呢?作为你的智慧伙伴，我不仅可以提供煤矿知识、分享安全经验、还可以和你探讨矿业发展，想知道我还能做些什么吗? 你可以这样问我: ",
		helpcontent:
			"1. 请给我讲讲煤矿开采的基本流程;2. 煤矿安全生产有哪些关键措施;3. 未来煤炭行业的发展趋势有哪些;",
		used: "使用",
		refresh: "刷新",
		like: "点赞",
		bad: "不喜欢",
	...
	voice: {
		...
		add: "添加",
		generateInfo:
			"控制语音生成的多样性，值越大，生成的语音将具备更高的表现力上限与随机性范围；应为0到100的整数,建议不小于95",
		stability: "稳定性过滤 (0-100,默认为100)",
		stabilityInfo:
			"限制在生成过程中仅选择前n个最佳的路径，值越小，生成的语音通常越平淡与稳定，但同时也可能导致表达某些内容或音色时的效果下降或异常；应为1到100的整数，为0时关闭限制，启用时建议不小于40",
		start: "开始生成",
		diversity: "多样性",
	...
	store: {
		...
		redeemKey: "兑换",
		token:
			"1000个Token大约相当于750个英文单词或400至500个汉字。在按Token计费的模型中，每使用1000个Token将进行一次扣费。",
		input: "请输入卡密",
		day: "天",
		siderButton: "应用市场",
		local: "本地",
	...
	mj: {
		...
		"uploadSuccess": "上传成功",
		"uploadFail": "上传失败:",
		"attachmentPresentWarning": "存在附件时无法启用深度思考模式",
		"upPdf": "<span>上传图片或附件<br/>可以上上传图片、PDF、EXCEL等文档</span><p>支持拖拽</p>",
		"upImg": "<span><b>上传图片</b><br/>将自动调用 qwen/qwen2.5-vl-72b-instruct 模型<br/>格式：jpeg、jpg、png、gif</span><p>支持拖拽</p>",
		clearAll: "清参数",
		czoom: "自定义",
		customTitle: "自定义变焦",
		...
		tokenInfo1:
			"剩余Tokens = 模型最大Tokens容量 - 角色设定 - 上下文(会话历史) - 回复数 - 当前输入",
