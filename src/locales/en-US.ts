export default {
	...
	chat: {
		...
		annouceContent:
			"All content on this website is related to coal mining knowledge and is used at the user’s own risk.;This website is for coal mining study and reference purposes only.;Any issues arising from using this website shall be borne by the user.",
