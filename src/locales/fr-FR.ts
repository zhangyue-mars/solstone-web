export default {
    ...
    "mj": {
        ...
        "noReUpload": "Impossible de télécharger à nouveau",
        "uploading": "Téléchargement en cours...",
        "uploadSuccess": "Téléchargement réussi",
        "uploadFail": "Échec du téléchargement :",
        "attachmentPresentWarning": "Impossible d'activer le mode de réflexion approfondie lorsque des pièces jointes sont présentes",
        "upPdf": "<span>Télécharger une image ou une pièce jointe<br/>Vous pouvez télécharger des images, des PDF, des EXCEL et d'autres documents</span><p>Glisser-déposer pris en charge</p>",
        "upImg": "<span><b>Télécharger une image</b><br/>Invoquera automatiquement le modèle gpt-4-vision-preview<br>Remarque : Des frais d'image supplémentaires peuvent s'appliquer<br/>Formats : jpeg, jpg, png, gif</span><p>Glisser-déposer pris en charge</p><p class=\"pt-2\"><b>Télécharger MP3 MP4</b><br/>Invoquera automatiquement directement le modèle whisper-1<br/>Formats : mp3, mp4, mpeg, mpga, m4a, wav, webm</p>",
